...
export class Films extends Component {
  ...
  axios
      .get(`https://kinopoiskapiunofficial.tech/api/v2.1/films/search-by-filters?order=${arrRandomOrd[randomOrd]}&type=FILM&ratingFrom=4&ratingTo=${arrRandomOrder[randomOrder]}&yearFrom=1964&yearTo=${arrRandomYear[randomForYear]}&page=${randomInt}`,
             {headers: {
...
componentDidMount(){
  ...
  axios
      .get(`https://kinopoiskapiunofficial.tech/api/v2.1/films/search-by-filters?order=${arrRandomOrder[randomOrder]}&type=FILM&ratingFrom=5&ratingTo=10&yearFrom=2000&yearTo=2021&page=${randomInt}`,
             {headers: {
               'X-API-KEY': '28205e94-58cc-4655-96df-b2b5d0e377b8'
             }} )
   ...
   render(){
    ...
    return (
        <SafeAreaView style={ {backgroundColor:'#040114', flex:1,} }>
          ...
          <Text style={{color:'#fff', fontSize:24, padding:5, marginLeft:8, fontWeight:'bold'}}>Фильмы</Text>
